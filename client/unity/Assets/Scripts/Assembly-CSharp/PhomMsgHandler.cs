	...
	public void onMessage(Message msg)
	{
		try
		{
			...
			case 21:
			{
				...
				Canvas.endDlg();
				PBoardScr.gI().onFire(currentP, firstP, num5, numberCard);
				break;
			}
			case 63:
			{
				int cardGet = msg.reader().readByte();
				Canvas.endDlg();
			...
			case 64:
			{
				...
				if (flag3)
				{
					numEat = msg.reader().readByte();
				}
				sbyte nCard = msg.reader().readByte();
				Canvas.endDlg();
				PBoardScr.gI().onEatCard(flag3, numEat, firHa2, nCard);
				break;
			}
			case 65:
			{
			...
			case 51:
			{
				...
				{
					array5[num8] = msg.reader().readInt();
				}
				int[] array6 = new int[4];
				for (int num9 = 0; num9 < 4; num9++)
				{
					array6[num9] = msg.reader().readInt();
				}
				int[][] array7 = new int[4][];
				for (int num10 = 0; num10 < 4; num10++)
				{
					array7[num10] = new int[11];
				}
				for (int num11 = 0; num11 < 4; num11++)
				{
					for (int num12 = 0; num12 < 11; num12++)
					{
						array7[num11][num12] = -1;
					}
				}
				int num13 = 0;
				int num14 = 0;
			...
			case 67:
			{
				...
				Canvas.endDlg();
				PBoardScr.gI().onAddCardToPhom(flag, card);
				break;
			}
			case 68:
			{
			...
			case 62:
			{
				int interval = msg.reader().readByte();
